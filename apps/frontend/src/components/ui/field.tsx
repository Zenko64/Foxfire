...
function FieldSeparator({
	...
	return (
		<div
			...
			className={cn(
				"relative -my-2 h-5 text-xs flex items-center justify-center group-data-[variant=outline]/field-group:-mb-2",
				className,
			)}
			{...props}
		>
			...
			{children && (
				<span
					className="relative block w-fit bg-card px-2  text-muted-foreground"
